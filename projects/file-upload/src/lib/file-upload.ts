import { Validator, ControlValueAccessor, NG_VALIDATORS, NG_VALUE_ACCESSOR, AbstractControl, ValidationErrors } from '@angular/forms';
import { Component, ChangeDetectionStrategy, OnChanges, Input, TemplateRef, HostBinding, ElementRef, Renderer2, SimpleChanges } from '@angular/core';
...
export class XotbFileUpload implements ControlValueAccessor, Validator, OnChanges {
